...
# 1. Run cyclictest
cyclictest -l$HIST_LOOPS -m -Sp90 -i200 -h$HIST_MAX_LATENCY -q >output 
...
# 9. Move plot to httpd directory
mv plot.png /benchmark/generated/plot.png